...
export class TiendaService {
  ...
  /**
   * Verifica la existencia de una tienda por id.
   * Reemplaza a TiendaClientMock.exists() para los consumidores
   * dentro del módulo de Logística (CatalogoService, PedidoService).
   */
